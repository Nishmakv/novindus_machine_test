          ...
          return BlocBuilder<PatientRegisterCubit, PatientRegisterState>(
            builder: (context, state) {
              if (state is PatientRegisterSuccess) {
                int? numberOfMales = state.numberOfMales;
                int? numberOfFemales = state.numberOfFemales;
                return Padding(
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child:
                                Center(child: Text(numberOfMales.toString())),
                          ),
                          const SizedBox(width: 7),
                          GestureDetector(
                            onTap: () {
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child:
                                Center(child: Text(numberOfFemales.toString())),
                          ),
                          const SizedBox(width: 7),
                          const CircleAvatar(
                            backgroundColor: Color(0xFF006837),
